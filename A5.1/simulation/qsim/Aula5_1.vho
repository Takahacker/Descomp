...
SIGNAL \MUX_B_ULA|ALT_INV_saida_MUX[2]~2_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\MUX_B_ULA|ALT_INV_saida_MUX[2]~2_combout\ <= NOT \MUX_B_ULA|saida_MUX[2]~2_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \MUX_B_ULA|ALT_INV_saida_MUX[0]~0_combout\,
	devoe => ww_devoe,
	o => ww_EntradaB_ULA(0));
...
-- pragma translate_on
PORT MAP (
	i => \MUX_B_ULA|ALT_INV_saida_MUX[2]~2_combout\,
	devoe => ww_devoe,
	o => ww_EntradaB_ULA(2));
...
-- Equation(s):
-- \ROM1|memROM~7_combout\ = (!\PC|DOUT\(8) & (\ROM1|memROM~1_combout\ & \ROM1|memROM~4_combout\))
...
-- Equation(s):
-- \ROM1|memROM~0_combout\ = (!\PC|DOUT\(3) & ((!\PC|DOUT\(2) & ((!\PC|DOUT\(1)))) # (\PC|DOUT\(2) & (!\PC|DOUT\(0)))))
...
-- Equation(s):
-- \ROM1|memROM~5_combout\ = (!\PC|DOUT\(3) & ((!\PC|DOUT\(1) & ((!\PC|DOUT\(2)))) # (\PC|DOUT\(1) & (!\PC|DOUT\(0) & \PC|DOUT\(2)))))
...
-- Equation(s):
-- \ROM1|memROM~8_combout\ = (!\PC|DOUT\(8) & (\ROM1|memROM~1_combout\ & \ROM1|memROM~5_combout\))
...
-- Equation(s):
-- \ROM1|memROM~6_combout\ = (!\PC|DOUT\(8) & (\ROM1|memROM~1_combout\ & \ROM1|memROM~3_combout\))
...
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[0]~0_combout\ = ((!\ROM1|memROM~0_combout\) # ((!\ROM1|memROM~1_combout\) # (!\ROM1|memROM~3_combout\))) # (\PC|DOUT\(8))
...
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[1]~1_combout\ = (!\PC|DOUT\(8) & (\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & \ROM1|memROM~4_combout\)))
...
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[2]~2_combout\ = ((!\ROM1|memROM~0_combout\) # ((!\ROM1|memROM~1_combout\) # (!\ROM1|memROM~5_combout\))) # (\PC|DOUT\(8))
