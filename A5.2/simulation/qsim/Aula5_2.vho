...
SIGNAL \MUX_B_ULA|saida_MUX[4]~9_combout\ : std_logic;
...
SIGNAL \DEC1|Equal3~0_combout\ : std_logic;
...
SIGNAL \FlagIgual|DOUT~4_combout\ : std_logic;
...
SIGNAL \ROM1|memROM~7_wirecell_combout\ : std_logic;
...
SIGNAL \DEC1|saida~3_combout\ : std_logic;
...
SIGNAL \MUX_B_ULA|saida_MUX[4]~5_combout\ : std_logic;
SIGNAL \MUX_B_ULA|saida_MUX[5]~6_combout\ : std_logic;
SIGNAL \MUX_B_ULA|saida_MUX[6]~7_combout\ : std_logic;
SIGNAL \MUX_B_ULA|saida_MUX[7]~8_combout\ : std_logic;
...
SIGNAL \MUX_B_ULA|ALT_INV_saida_MUX[4]~4_combout\ : std_logic;
...
SIGNAL \DEC1|ALT_INV_Equal3~0_combout\ : std_logic;
...
SIGNAL \MUX_B_ULA|ALT_INV_saida_MUX[4]~9_combout\ : std_logic;
...
SIGNAL \FlagIgual|ALT_INV_DOUT~0_combout\ : std_logic;
...
\MUX_B_ULA|ALT_INV_saida_MUX[4]~4_combout\ <= NOT \MUX_B_ULA|saida_MUX[4]~4_combout\;
...
\DEC1|ALT_INV_Equal3~0_combout\ <= NOT \DEC1|Equal3~0_combout\;
...
\MUX_B_ULA|ALT_INV_saida_MUX[4]~9_combout\ <= NOT \MUX_B_ULA|saida_MUX[4]~9_combout\;
...
\FlagIgual|ALT_INV_DOUT~0_combout\ <= NOT \FlagIgual|DOUT~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \MUX_B_ULA|saida_MUX[4]~5_combout\,
	devoe => ww_devoe,
	o => ww_EntradaB_ULA(4));
...
-- pragma translate_on
PORT MAP (
	i => \MUX_B_ULA|saida_MUX[5]~6_combout\,
	devoe => ww_devoe,
	o => ww_EntradaB_ULA(5));
...
-- pragma translate_on
PORT MAP (
	i => \MUX_B_ULA|saida_MUX[6]~7_combout\,
	devoe => ww_devoe,
	o => ww_EntradaB_ULA(6));
...
-- pragma translate_on
PORT MAP (
	i => \MUX_B_ULA|saida_MUX[7]~8_combout\,
	devoe => ww_devoe,
	o => ww_EntradaB_ULA(7));
...
-- Equation(s):
-- \ROM1|memROM~2_combout\ = (!\PC|DOUT\(1) & ((!\PC|DOUT\(2) & ((!\PC|DOUT\(3)))) # (\PC|DOUT\(2) & (!\PC|DOUT\(0) & \PC|DOUT\(3))))) # (\PC|DOUT\(1) & (\PC|DOUT\(0) & (!\PC|DOUT\(2) $ (!\PC|DOUT\(3)))))
...
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[4]~4_combout\ = ( \ROM1|memROM~4_combout\ ) # ( !\ROM1|memROM~4_combout\ & ( ((!\ROM1|memROM~1_combout\) # ((\ROM1|memROM~3_combout\) # (\ROM1|memROM~2_combout\))) # (\ROM1|memROM~0_combout\) ) )
...
\MUX_B_ULA|saida_MUX[4]~9\ : cyclonev_lcell_comb
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[4]~9_combout\ = (!\ROM1|memROM~1_combout\) # (((\ROM1|memROM~4_combout\) # (\ROM1|memROM~3_combout\)) # (\ROM1|memROM~2_combout\))
...
PORT MAP (
	...
	combout => \MUX_B_ULA|saida_MUX[4]~9_combout\);

\ROM1|memROM~10\ : cyclonev_lcell_comb
-- Equation(s):
-- \ROM1|memROM~10_combout\ = (\ROM1|memROM~0_combout\ & \ROM1|memROM~1_combout\)
...
-- Equation(s):
-- \ULA1|saida[7]~7_combout\ = (\MUX_B_ULA|saida_MUX[4]~4_combout\ & \ULA1|Add0~29_sumout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \MUX_B_ULA|ALT_INV_saida_MUX[4]~4_combout\,
	datab => \ULA1|ALT_INV_Add0~29_sumout\,
	combout => \ULA1|saida[7]~7_combout\);

\DEC1|saida[5]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC1|saida[5]~2_combout\ = ( \ROM1|memROM~4_combout\ & ( (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~3_combout\ & ((\ROM1|memROM~2_combout\) # (\ROM1|memROM~0_combout\)))) ) ) # ( !\ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & 
-- (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010000000000000000100110000000000100000000000000001001100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ROM1|ALT_INV_memROM~0_combout\,
...
-- Equation(s):
-- \ROM1|memROM~7_combout\ = ( \ROM1|memROM~1_combout\ & ( (!\PC|DOUT\(0) $ (((!\PC|DOUT\(3)) # (\PC|DOUT\(2))))) # (\PC|DOUT\(1)) ) ) # ( !\ROM1|memROM~1_combout\ )
...
\DEC1|Equal3~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC1|Equal3~0_combout\ = ( !\ROM1|memROM~4_combout\ & ( (\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) )
...
-- Equation(s):
-- \RAM1|ram~165_combout\ = ( \ROM1|memROM~9_combout\ & ( \DEC1|Equal3~0_combout\ & ( (!\ROM1|memROM~5_combout\ & (!\ROM1|memROM~6_combout\ & (\ROM1|memROM~7_combout\ & !\ROM1|memROM~8_combout\))) ) ) )
...
PORT MAP (
	...
	dataf => \DEC1|ALT_INV_Equal3~0_combout\,
...
-- Equation(s):
-- \RAM1|ram~166_combout\ = ( \ROM1|memROM~9_combout\ & ( \DEC1|Equal3~0_combout\ & ( (\ROM1|memROM~5_combout\ & (!\ROM1|memROM~6_combout\ & (\ROM1|memROM~7_combout\ & !\ROM1|memROM~8_combout\))) ) ) )
...
-- Equation(s):
-- \ULA1|Add0~1_sumout\ = SUM(( (!\DEC1|Equal4~0_combout\ & ((!\RAM1|ram~146_combout\))) # (\DEC1|Equal4~0_combout\ & (!\ROM1|memROM~5_combout\)) ) + ( \REGA|DOUT\(0) ) + ( \ULA1|Add0~34_cout\ ))
-- \ULA1|Add0~2\ = CARRY(( (!\DEC1|Equal4~0_combout\ & ((!\RAM1|ram~146_combout\))) # (\DEC1|Equal4~0_combout\ & (!\ROM1|memROM~5_combout\)) ) + ( \REGA|DOUT\(0) ) + ( \ULA1|Add0~34_cout\ ))
...
-- Equation(s):
-- \ULA1|saida[0]~0_combout\ = (!\DEC1|Equal4~0_combout\ & ((\ULA1|Add0~1_sumout\))) # (\DEC1|Equal4~0_combout\ & (\ROM1|memROM~5_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \DEC1|ALT_INV_Equal4~0_combout\,
...
-- Equation(s):
-- \ULA1|Add0~5_sumout\ = SUM(( (!\DEC1|Equal4~0_combout\ & ((!\RAM1|ram~149_combout\))) # (\DEC1|Equal4~0_combout\ & (!\ROM1|memROM~6_combout\)) ) + ( \REGA|DOUT\(1) ) + ( \ULA1|Add0~2\ ))
-- \ULA1|Add0~6\ = CARRY(( (!\DEC1|Equal4~0_combout\ & ((!\RAM1|ram~149_combout\))) # (\DEC1|Equal4~0_combout\ & (!\ROM1|memROM~6_combout\)) ) + ( \REGA|DOUT\(1) ) + ( \ULA1|Add0~2\ ))
...
-- Equation(s):
-- \ULA1|saida[1]~1_combout\ = (!\DEC1|Equal4~0_combout\ & ((\ULA1|Add0~5_sumout\))) # (\DEC1|Equal4~0_combout\ & (\ROM1|memROM~6_combout\))
...
-- Equation(s):
-- \ULA1|Add0~9_sumout\ = SUM(( (!\DEC1|Equal4~0_combout\ & ((!\RAM1|ram~151_combout\))) # (\DEC1|Equal4~0_combout\ & (\ROM1|memROM~7_combout\)) ) + ( \REGA|DOUT\(2) ) + ( \ULA1|Add0~6\ ))
-- \ULA1|Add0~10\ = CARRY(( (!\DEC1|Equal4~0_combout\ & ((!\RAM1|ram~151_combout\))) # (\DEC1|Equal4~0_combout\ & (\ROM1|memROM~7_combout\)) ) + ( \REGA|DOUT\(2) ) + ( \ULA1|Add0~6\ ))
...
-- Equation(s):
-- \ULA1|saida[2]~2_combout\ = (!\DEC1|Equal4~0_combout\ & ((\ULA1|Add0~9_sumout\))) # (\DEC1|Equal4~0_combout\ & (!\ROM1|memROM~7_combout\))
...
-- Equation(s):
-- \ULA1|Add0~13_sumout\ = SUM(( (!\DEC1|Equal4~0_combout\ & ((!\RAM1|ram~154_combout\))) # (\DEC1|Equal4~0_combout\ & (!\ROM1|memROM~8_combout\)) ) + ( \REGA|DOUT\(3) ) + ( \ULA1|Add0~10\ ))
-- \ULA1|Add0~14\ = CARRY(( (!\DEC1|Equal4~0_combout\ & ((!\RAM1|ram~154_combout\))) # (\DEC1|Equal4~0_combout\ & (!\ROM1|memROM~8_combout\)) ) + ( \REGA|DOUT\(3) ) + ( \ULA1|Add0~10\ ))
...
-- Equation(s):
-- \ULA1|saida[3]~3_combout\ = (!\DEC1|Equal4~0_combout\ & ((\ULA1|Add0~13_sumout\))) # (\DEC1|Equal4~0_combout\ & (\ROM1|memROM~8_combout\))
...
-- Equation(s):
-- \ULA1|Add0~17_sumout\ = SUM(( (!\MUX_B_ULA|saida_MUX[4]~4_combout\) # (!\RAM1|ram~156_combout\) ) + ( \REGA|DOUT\(4) ) + ( \ULA1|Add0~14\ ))
-- \ULA1|Add0~18\ = CARRY(( (!\MUX_B_ULA|saida_MUX[4]~4_combout\) # (!\RAM1|ram~156_combout\) ) + ( \REGA|DOUT\(4) ) + ( \ULA1|Add0~14\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \MUX_B_ULA|ALT_INV_saida_MUX[4]~4_combout\,
...
-- Equation(s):
-- \ULA1|saida[4]~4_combout\ = (\MUX_B_ULA|saida_MUX[4]~4_combout\ & \ULA1|Add0~17_sumout\)
...
-- Equation(s):
-- \ULA1|Add0~21_sumout\ = SUM(( (!\RAM1|ram~159_combout\) # ((!\ROM1|memROM~10_combout\ & !\MUX_B_ULA|saida_MUX[4]~9_combout\)) ) + ( \REGA|DOUT\(5) ) + ( \ULA1|Add0~18\ ))
-- \ULA1|Add0~22\ = CARRY(( (!\RAM1|ram~159_combout\) # ((!\ROM1|memROM~10_combout\ & !\MUX_B_ULA|saida_MUX[4]~9_combout\)) ) + ( \REGA|DOUT\(5) ) + ( \ULA1|Add0~18\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111110000000000000000000000001111110011110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \ROM1|ALT_INV_memROM~10_combout\,
	datac => \RAM1|ALT_INV_ram~159_combout\,
	datad => \MUX_B_ULA|ALT_INV_saida_MUX[4]~9_combout\,
...
-- Equation(s):
-- \ULA1|saida[5]~5_combout\ = (\MUX_B_ULA|saida_MUX[4]~4_combout\ & \ULA1|Add0~21_sumout\)
...
-- Equation(s):
-- \ULA1|Add0~25_sumout\ = SUM(( (!\RAM1|ram~161_combout\) # ((!\ROM1|memROM~10_combout\ & !\MUX_B_ULA|saida_MUX[4]~9_combout\)) ) + ( \REGA|DOUT\(6) ) + ( \ULA1|Add0~22\ ))
-- \ULA1|Add0~26\ = CARRY(( (!\RAM1|ram~161_combout\) # ((!\ROM1|memROM~10_combout\ & !\MUX_B_ULA|saida_MUX[4]~9_combout\)) ) + ( \REGA|DOUT\(6) ) + ( \ULA1|Add0~22\ ))
...
-- Equation(s):
-- \ULA1|saida[6]~6_combout\ = (\MUX_B_ULA|saida_MUX[4]~4_combout\ & \ULA1|Add0~25_sumout\)
...
-- Equation(s):
-- \ULA1|Add0~29_sumout\ = SUM(( (!\RAM1|ram~164_combout\) # ((!\MUX_B_ULA|saida_MUX[4]~9_combout\ & !\ROM1|memROM~10_combout\)) ) + ( \REGA|DOUT\(7) ) + ( \ULA1|Add0~26\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111110000000000000000000000001111111111000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \MUX_B_ULA|ALT_INV_saida_MUX[4]~9_combout\,
...
-- Equation(s):
-- \DEC1|saida[2]~1_combout\ = ( \ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ $ (!\ROM1|memROM~3_combout\)))) ) )
...
-- Equation(s):
-- \FlagIgual|DOUT~0_combout\ = (!\DEC1|saida[2]~1_combout\ & \FlagIgual|DOUT~q\)
...
-- pragma translate_on
PORT MAP (
	dataa => \DEC1|ALT_INV_saida[2]~1_combout\,
	datab => \FlagIgual|ALT_INV_DOUT~q\,
	combout => \FlagIgual|DOUT~0_combout\);

\FlagIgual|DOUT~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \FlagIgual|DOUT~1_combout\ = (\MUX_B_ULA|saida_MUX[4]~4_combout\ & (((\ULA1|Add0~25_sumout\) # (\ULA1|Add0~21_sumout\)) # (\ULA1|Add0~17_sumout\)))
...
-- Equation(s):
-- \FlagIgual|DOUT~2_combout\ = ( \ULA1|Add0~1_sumout\ & ( \ULA1|Add0~5_sumout\ & ( (\DEC1|saida[2]~1_combout\ & (\DEC1|Equal4~0_combout\ & (!\ROM1|memROM~5_combout\ & !\ROM1|memROM~6_combout\))) ) ) ) # ( !\ULA1|Add0~1_sumout\ & ( \ULA1|Add0~5_sumout\ & ( 
-- (\DEC1|saida[2]~1_combout\ & (\DEC1|Equal4~0_combout\ & (!\ROM1|memROM~5_combout\ & !\ROM1|memROM~6_combout\))) ) ) ) # ( \ULA1|Add0~1_sumout\ & ( !\ULA1|Add0~5_sumout\ & ( (\DEC1|saida[2]~1_combout\ & (\DEC1|Equal4~0_combout\ & (!\ROM1|memROM~5_combout\ 
-- & !\ROM1|memROM~6_combout\))) ) ) ) # ( !\ULA1|Add0~1_sumout\ & ( !\ULA1|Add0~5_sumout\ & ( (\DEC1|saida[2]~1_combout\ & ((!\DEC1|Equal4~0_combout\) # ((!\ROM1|memROM~5_combout\ & !\ROM1|memROM~6_combout\)))) ) ) )
...
-- Equation(s):
-- \FlagIgual|DOUT~3_combout\ = ( \ULA1|Add0~13_sumout\ & ( (\DEC1|Equal4~0_combout\ & (\ROM1|memROM~7_combout\ & !\ROM1|memROM~8_combout\)) ) ) # ( !\ULA1|Add0~13_sumout\ & ( (!\DEC1|Equal4~0_combout\ & (((!\ULA1|Add0~9_sumout\)))) # 
-- (\DEC1|Equal4~0_combout\ & (\ROM1|memROM~7_combout\ & (!\ROM1|memROM~8_combout\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1011101000010000000100000001000010111010000100000001000000010000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DEC1|ALT_INV_Equal4~0_combout\,
...
\FlagIgual|DOUT~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \FlagIgual|DOUT~4_combout\ = ( \FlagIgual|DOUT~2_combout\ & ( \FlagIgual|DOUT~3_combout\ & ( ((!\FlagIgual|DOUT~1_combout\ & ((!\MUX_B_ULA|saida_MUX[4]~4_combout\) # (!\ULA1|Add0~29_sumout\)))) # (\FlagIgual|DOUT~0_combout\) ) ) ) # ( 
-- !\FlagIgual|DOUT~2_combout\ & ( \FlagIgual|DOUT~3_combout\ & ( \FlagIgual|DOUT~0_combout\ ) ) ) # ( \FlagIgual|DOUT~2_combout\ & ( !\FlagIgual|DOUT~3_combout\ & ( \FlagIgual|DOUT~0_combout\ ) ) ) # ( !\FlagIgual|DOUT~2_combout\ & ( 
-- !\FlagIgual|DOUT~3_combout\ & ( \FlagIgual|DOUT~0_combout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111100001111000011110000111100001111000011111110111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \MUX_B_ULA|ALT_INV_saida_MUX[4]~4_combout\,
	datab => \ULA1|ALT_INV_Add0~29_sumout\,
	datac => \FlagIgual|ALT_INV_DOUT~0_combout\,
	datad => \FlagIgual|ALT_INV_DOUT~1_combout\,
	datae => \FlagIgual|ALT_INV_DOUT~2_combout\,
	dataf => \FlagIgual|ALT_INV_DOUT~3_combout\,
	combout => \FlagIgual|DOUT~4_combout\);
...
-- Equation(s):
-- \LogicaDesvio|saida~0_combout\ = ( !\ROM1|memROM~4_combout\ & ( \FlagIgual|DOUT~q\ & ( (\ROM1|memROM~1_combout\ & (\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\)) ) ) ) # ( !\ROM1|memROM~4_combout\ & ( !\FlagIgual|DOUT~q\ & ( 
-- (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001000000000000000000000000000000011000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ROM1|ALT_INV_memROM~0_combout\,
...
\ROM1|memROM~7_wirecell\ : cyclonev_lcell_comb
-- Equation(s):
-- \ROM1|memROM~7_wirecell_combout\ = !\ROM1|memROM~7_combout\
...
PORT MAP (
	...
	combout => \ROM1|memROM~7_wirecell_combout\);
...
PORT MAP (
	...
	asdata => \ROM1|memROM~7_wirecell_combout\,
	sload => \LogicaDesvio|saida~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \PC|DOUT\(2));
...
-- Equation(s):
-- \DEC1|saida[1]~0_combout\ = ( \ROM1|memROM~4_combout\ & ( (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~3_combout\ $ (((!\ROM1|memROM~0_combout\ & !\ROM1|memROM~2_combout\))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000100110010000000000000000000000001001100100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ROM1|ALT_INV_memROM~0_combout\,
...
\DEC1|saida~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC1|saida~3_combout\ = ( !\ROM1|memROM~4_combout\ & ( (\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) )
...
PORT MAP (
	...
	datad => \ROM1|ALT_INV_memROM~3_combout\,
	datae => \ROM1|ALT_INV_memROM~4_combout\,
	combout => \DEC1|saida~3_combout\);

\DEC1|Equal2~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC1|Equal2~0_combout\ = ( !\ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) )
...
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[0]~0_combout\ = (!\DEC1|Equal4~0_combout\ & ((\RAM1|ram~146_combout\))) # (\DEC1|Equal4~0_combout\ & (\ROM1|memROM~5_combout\))
...
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[1]~1_combout\ = (!\DEC1|Equal4~0_combout\ & ((\RAM1|ram~149_combout\))) # (\DEC1|Equal4~0_combout\ & (\ROM1|memROM~6_combout\))
...
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[2]~2_combout\ = (!\DEC1|Equal4~0_combout\ & ((\RAM1|ram~151_combout\))) # (\DEC1|Equal4~0_combout\ & (!\ROM1|memROM~7_combout\))
...
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[3]~3_combout\ = (!\DEC1|Equal4~0_combout\ & ((\RAM1|ram~154_combout\))) # (\DEC1|Equal4~0_combout\ & (\ROM1|memROM~8_combout\))
...
\MUX_B_ULA|saida_MUX[4]~5\ : cyclonev_lcell_comb
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[4]~5_combout\ = (\MUX_B_ULA|saida_MUX[4]~4_combout\ & \RAM1|ram~156_combout\)
...
PORT MAP (
	...
	combout => \MUX_B_ULA|saida_MUX[4]~5_combout\);

\MUX_B_ULA|saida_MUX[5]~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[5]~6_combout\ = (\MUX_B_ULA|saida_MUX[4]~4_combout\ & \RAM1|ram~159_combout\)
...
PORT MAP (
	...
	combout => \MUX_B_ULA|saida_MUX[5]~6_combout\);

\MUX_B_ULA|saida_MUX[6]~7\ : cyclonev_lcell_comb
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[6]~7_combout\ = (\MUX_B_ULA|saida_MUX[4]~4_combout\ & \RAM1|ram~161_combout\)
...
PORT MAP (
	...
	combout => \MUX_B_ULA|saida_MUX[6]~7_combout\);

\MUX_B_ULA|saida_MUX[7]~8\ : cyclonev_lcell_comb
-- Equation(s):
-- \MUX_B_ULA|saida_MUX[7]~8_combout\ = (\MUX_B_ULA|saida_MUX[4]~4_combout\ & \RAM1|ram~164_combout\)
...
PORT MAP (
	...
	combout => \MUX_B_ULA|saida_MUX[7]~8_combout\);
