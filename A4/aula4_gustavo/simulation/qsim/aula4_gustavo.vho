...
ARCHITECTURE structure OF Aula4_Gustavo IS
...
SIGNAL \DEC1|Equal5~1_combout\ : std_logic;
...
SIGNAL \DEC1|saida~1_combout\ : std_logic;
...
SIGNAL \DEC1|ALT_INV_Equal5~1_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\DEC1|ALT_INV_Equal5~1_combout\ <= NOT \DEC1|Equal5~1_combout\;
...
-- Equation(s):
-- \DEC1|Equal5~0_combout\ = (!\PC|DOUT\(0) & (\ROM1|memROM~1_combout\ & (!\PC|DOUT\(3) & !\PC|DOUT\(2))))
...
\DEC1|Equal5~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC1|Equal5~1_combout\ = (!\PC|DOUT\(1) & (\ROM1|memROM~1_combout\ & (!\PC|DOUT\(3) & \PC|DOUT\(2))))
...
-- Equation(s):
-- \ULA1|Add0~34_cout\ = CARRY(( !\DEC1|Equal5~1_combout\ ) + ( VCC ) + ( !VCC ))
...
-- pragma translate_on
PORT MAP (
	datad => \DEC1|ALT_INV_Equal5~1_combout\,
	cin => GND,
	cout => \ULA1|Add0~34_cout\);

\ULA1|Add0~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \ULA1|Add0~1_sumout\ = SUM(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & ((\RAM1|ram~85_combout\))) # (\DEC1|Equal5~0_combout\ & (\ROM1|memROM~4_combout\)))) ) + ( \REGA|DOUT\(0) ) + ( \ULA1|Add0~34_cout\ ))
-- \ULA1|Add0~2\ = CARRY(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & ((\RAM1|ram~85_combout\))) # (\DEC1|Equal5~0_combout\ & (\ROM1|memROM~4_combout\)))) ) + ( \REGA|DOUT\(0) ) + ( \ULA1|Add0~34_cout\ ))
...
PORT MAP (
	...
	datab => \ROM1|ALT_INV_memROM~4_combout\,
	datac => \DEC1|ALT_INV_Equal5~1_combout\,
...
-- Equation(s):
-- \MUX1|saida_MUX[0]~0_combout\ = (!\DEC1|Equal5~0_combout\ & ((\RAM1|ram~85_combout\))) # (\DEC1|Equal5~0_combout\ & (\ROM1|memROM~4_combout\))
...
\DEC1|saida~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC1|saida~1_combout\ = ( \ROM1|memROM~2_combout\ & ( (\ROM1|memROM~1_combout\ & ((\PC|DOUT\(3)) # (\PC|DOUT\(2)))) ) ) # ( !\ROM1|memROM~2_combout\ & ( (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~0_combout\ $ (((\PC|DOUT\(3)) # (\PC|DOUT\(2)))))) ) )
...
PORT MAP (
	...
	sload => \DEC1|Equal5~0_combout\,
	ena => \DEC1|saida~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \REGA|DOUT\(0));
...
-- Equation(s):
-- \ULA1|Add0~5_sumout\ = SUM(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & ((\RAM1|ram~90_combout\))) # (\DEC1|Equal5~0_combout\ & (\ROM1|memROM~6_combout\)))) ) + ( \REGA|DOUT\(1) ) + ( \ULA1|Add0~2\ ))
-- \ULA1|Add0~6\ = CARRY(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & ((\RAM1|ram~90_combout\))) # (\DEC1|Equal5~0_combout\ & (\ROM1|memROM~6_combout\)))) ) + ( \REGA|DOUT\(1) ) + ( \ULA1|Add0~2\ ))
...
PORT MAP (
	dataa => \DEC1|ALT_INV_Equal5~0_combout\,
	datab => \DEC1|ALT_INV_Equal5~1_combout\,
...
-- Equation(s):
-- \MUX1|saida_MUX[1]~1_combout\ = (!\DEC1|Equal5~0_combout\ & ((\RAM1|ram~90_combout\))) # (\DEC1|Equal5~0_combout\ & (\ROM1|memROM~6_combout\))
...
-- Equation(s):
-- \ULA1|Add0~9_sumout\ = SUM(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & ((\RAM1|ram~95_combout\))) # (\DEC1|Equal5~0_combout\ & (\ROM1|memROM~7_combout\)))) ) + ( \REGA|DOUT\(2) ) + ( \ULA1|Add0~6\ ))
-- \ULA1|Add0~10\ = CARRY(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & ((\RAM1|ram~95_combout\))) # (\DEC1|Equal5~0_combout\ & (\ROM1|memROM~7_combout\)))) ) + ( \REGA|DOUT\(2) ) + ( \ULA1|Add0~6\ ))
...
-- Equation(s):
-- \MUX1|saida_MUX[2]~2_combout\ = (!\DEC1|Equal5~0_combout\ & ((\RAM1|ram~95_combout\))) # (\DEC1|Equal5~0_combout\ & (\ROM1|memROM~7_combout\))
...
-- Equation(s):
-- \ULA1|Add0~13_sumout\ = SUM(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & \RAM1|ram~100_combout\))) ) + ( \REGA|DOUT\(3) ) + ( \ULA1|Add0~10\ ))
-- \ULA1|Add0~14\ = CARRY(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & \RAM1|ram~100_combout\))) ) + ( \REGA|DOUT\(3) ) + ( \ULA1|Add0~10\ ))
...
-- pragma translate_on
PORT MAP (
	dataa => \DEC1|ALT_INV_Equal5~1_combout\,
	datab => \DEC1|ALT_INV_Equal5~0_combout\,
...
-- Equation(s):
-- \MUX1|saida_MUX[3]~3_combout\ = (!\DEC1|Equal5~0_combout\ & \RAM1|ram~100_combout\)
...
-- Equation(s):
-- \ULA1|Add0~17_sumout\ = SUM(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & \RAM1|ram~105_combout\))) ) + ( \REGA|DOUT\(4) ) + ( \ULA1|Add0~14\ ))
-- \ULA1|Add0~18\ = CARRY(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & \RAM1|ram~105_combout\))) ) + ( \REGA|DOUT\(4) ) + ( \ULA1|Add0~14\ ))
...
-- Equation(s):
-- \MUX1|saida_MUX[4]~4_combout\ = (!\DEC1|Equal5~0_combout\ & \RAM1|ram~105_combout\)
...
-- Equation(s):
-- \ULA1|Add0~21_sumout\ = SUM(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & \RAM1|ram~110_combout\))) ) + ( \REGA|DOUT\(5) ) + ( \ULA1|Add0~18\ ))
-- \ULA1|Add0~22\ = CARRY(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & \RAM1|ram~110_combout\))) ) + ( \REGA|DOUT\(5) ) + ( \ULA1|Add0~18\ ))
...
-- Equation(s):
-- \MUX1|saida_MUX[5]~5_combout\ = (!\DEC1|Equal5~0_combout\ & \RAM1|ram~110_combout\)
...
-- Equation(s):
-- \ULA1|Add0~25_sumout\ = SUM(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & \RAM1|ram~115_combout\))) ) + ( \REGA|DOUT\(6) ) + ( \ULA1|Add0~22\ ))
-- \ULA1|Add0~26\ = CARRY(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & \RAM1|ram~115_combout\))) ) + ( \REGA|DOUT\(6) ) + ( \ULA1|Add0~22\ ))
...
-- Equation(s):
-- \MUX1|saida_MUX[6]~6_combout\ = (!\DEC1|Equal5~0_combout\ & \RAM1|ram~115_combout\)
...
-- Equation(s):
-- \ULA1|Add0~29_sumout\ = SUM(( !\DEC1|Equal5~1_combout\ $ (((!\DEC1|Equal5~0_combout\ & \RAM1|ram~120_combout\))) ) + ( \REGA|DOUT\(7) ) + ( \ULA1|Add0~26\ ))
...
-- Equation(s):
-- \MUX1|saida_MUX[7]~7_combout\ = (!\DEC1|Equal5~0_combout\ & \RAM1|ram~120_combout\)
...
-- Equation(s):
-- \DEC1|saida~0_combout\ = ( \ROM1|memROM~2_combout\ & ( (\ROM1|memROM~1_combout\ & ((\PC|DOUT\(3)) # (\PC|DOUT\(2)))) ) ) # ( !\ROM1|memROM~2_combout\ & ( (\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & ((\PC|DOUT\(3)) # (\PC|DOUT\(2))))) ) )
